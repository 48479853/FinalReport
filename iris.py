# run_iris.py — TabPFN vs DecisionTree on Iris (3 classes)
...
def ovr_auc(y_true, proba, classes):
    """Macro One-vs-Rest ROC-AUC for multiclass; returns NaN if not computable."""
...
def main():
    ...
    print("Iris (multiclass) — 70/30 split, seed=42")
